package com.team.foodybox.logger;
...
import com.team.foodybox.utils.StackTraceUtil;
 ...
 *
 */
public class FoodyLogger {

	private final Logger logger;
	
	public static FoodyLogger getLogger(Class<?> cls) {
		return getLogger (cls.getName());
	}
	
	public static FoodyLogger getLogger(String pkgName) {
		return new FoodyLogger(Logger.getLogger(pkgName));
	}
	
	private FoodyLogger(Logger logger) {
		this.logger = logger;
	}
